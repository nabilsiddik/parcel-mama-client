            ...
            <div className="container">
                <div className='flex items-center justify-between'>
                    <div className='flex-1 text-center md:text-left'>
                        <Fade>
                            <h1 className=' mb-5 text-3xl md:text-5xl lg:text-5xl'>Fast & Reliable Parcel Delivery</h1>
                            <p className='w-11/12 md:w-8/12 mx-auto md:mx-0'>Parcel Mama deliver fast and secure delivery and always believe in customer satisfection.</p>
