...
const ContactPage = () => {
  return (
    <div id="contact_page">
      <div id="contact" className="pt-[180px] pb-20">
            ...
            <div className="contact-form w-full md:w-6/12 border py-5 px-5 rounded-lg">
              <form>
                <div className="input-gorup">
                  <div className="flex items-center gap-5">
                    <div className="w-6/12">
                      <label
                        className="label  mb-1 text-md block"
                        htmlFor="first name"
                      >
                        First Name
                      </label>
                      <input
                        type="text"
                        className="input input-bordered py-6 border w-full"
                ...
                <div className="input-group mt-7">
                  ...
                  <input
                    type="text"
                    className="input input-bordered py-6 borde w-full"
                    placeholder="Your Phone / Whatsapp"
                  />
                </div>
                ...
                <div className="mt-7">
                  ...
                  <textarea
                    rows={5}
                    className="textarea textarea-bordered w-full borde"
                ...
                <div>
                  <input
                    type="submit"
                    value={"Submit"}
                    className="btn bg-red-600 text-white text-lg hover:bg-red-600 w-full mt-5"
                  />
                </div>
              </form>
            </div>
